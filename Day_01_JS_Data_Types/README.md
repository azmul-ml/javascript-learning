...
*Lexical scope is all about where a variable is define instead of where it's beign invoked.*
...
5. }
```
Above code give us a `syntax error`. So how does it know about the error through line 5 without printing 1st line. So before execution it's being parsed or compiled by js engine.
...
```js
var name = "Rifat"
var msg = `Javascript's beauty is simplicity`
`Hello, ${name}`
```
